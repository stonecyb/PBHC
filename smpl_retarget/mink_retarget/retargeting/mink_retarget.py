...
_N2_KEYPOINT_TO_JOINT = {
    "Pelvis": {"name": "base_link", "weight": 5.0},
    "Head": {"name": "head", "weight": 5.0},
    # Legs.
    "L_Hip": {"name": "L_leg_hip_yaw_link", "weight": 1.0},
    "R_Hip": {"name": "R_leg_hip_yaw_link", "weight": 1.0},
    "L_Knee": {"name": "L_leg_knee_link", "weight": 2.0},
    "R_Knee": {"name": "R_leg_knee_link", "weight": 2.0},
    "L_Ankle": {"name": "L_leg_ankle_link", "weight": 1.0},
    "R_Ankle": {"name": "R_leg_ankle_link", "weight": 1.0},
    # Arms.
    "L_Elbow": {"name": "L_arm_elbow_Link", "weight": 1.0},
    "R_Elbow": {"name": "R_arm_elbow_Link", "weight": 1.0},
    "L_Wrist": {"name": "left_hand_link", "weight": 1.0},
    "R_Wrist": {"name": "right_hand_link", "weight": 1.0},
    "L_Shoulder": {"name": "L_arm_shoulder_pitch_Link", "weight": 3.0},
    "R_Shoulder": {"name": "R_arm_shoulder_pitch_Link", "weight": 3.0},
