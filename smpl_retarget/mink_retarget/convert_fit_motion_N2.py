...
def main(
    ...
    for folder_name in folder_names:
        if "retarget" in folder_name or "smpl" in folder_name or "h1" in folder_name or "N2" in folder_name:
        ...
        for filename in tqdm(files):
                ...
                origin_global_trans[..., 2] -= origin_verts[0, :, 2].min().item() + 1
                joints[..., 2] -= verts[0, :, 2].min().item() + 1
                root_pos = joints[:, 0]
